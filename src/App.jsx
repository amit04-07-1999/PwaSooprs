...
import GigsOrder from "./Gigslist/GigsOrder";
import GigPayment from "./Gigslist/GigPayment";

function App() {
  return (
    <div className="" style={{ maxWidth: "430px", height:"932px"}}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/gigpayment" element={<GigPayment/>}/>
          <Route path="/gigsorder" element={<GigsOrder/>}/>

...
function OffcanvasProjectPosting() {
  ...
  return (
    <>
      <Button variant="primary" onClick={handleShow}type="submit" className='form-control mt-5 bg-primary text-white' style={{ height: "4rem" }}>Complete
      </Button>
...
export default OffcanvasProjectPosting;
